...
const createRestoDetailTemplate = (resto) => `
  ...
  <picture>
    ...
    <img class="resto__poster lazyload" src="${CONFIG.MEDIUM_IMAGE_URL}${resto.pictureId}" alt="${resto.name}">
  </picture>
  ...
  <div class="resto-item">
    <div class="resto-item__header">
      <picture>
        <source type="image/webp" media="(max-width: 600px)" data-srcset="${CONFIG.SMALL_IMAGE_URL}${resto.pictureId}">
        <source type="image/png" media="(max-width: 600px)" data-srcset="${CONFIG.SMALL_IMAGE_URL}${resto.pictureId}">
        <img class="resto-item__header__poster lazyload" alt="${resto.name || '-'}" src="${CONFIG.MEDIUM_IMAGE_URL + resto.pictureId}">
      </picture>
